...
echo 'run this command and open another terminal to check'
echo 'kubectl proxy --address='0.0.0.0' --disable-filter=true'
echo 'try to access web pages outside containers'
